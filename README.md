...
My interest in machine learning and artificial intelligence started when I was in my final year pursuing Bachelor of Technology. I remember that we had to pick a final year project. During that time, I could see that machine learning and artificial intelligence were talked about mostly on the internet, and it's potential to revolutionize people's lives. I suggested my teammates that using learning for healthcare is a really good practice. Me and my teammates worked with using Machine Learning to predict the chances of a person to suffer from a Heart Disease respectively. We were able to download a toy dataset from Kaggle and were able to implement the machine learning models for predictions for heart disease dataset. We were able to get good results on the test set. I could see how machine learning was used for diagnosing whether a person would suffer from a heart disease or not. It spiked an interest where I tried to look for ways at which I could apply machine learning. I came across Kaggle - a website that allows people to download datasets for machine learning and artificial intelligence purposes. I applied my knowledge of machine learning and data science in different domans such as healtcare, academia and retail industries.😁😀
