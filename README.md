...
<img src = "https://github.com/suhasmaddali/Images/blob/main/Latest%20Gif%20File%20Introduction.gif" width = 1000 height = 400/>
...
📃 [__10 Tips to become a Data Scientist or Machine Learning Engineer__](https://medium.com/towards-data-science/10-tips-to-become-a-data-scientist-or-machine-learning-engineer-8c0700976f9e) - In this blog, I have discussed some of the important ways at which we can become a data scientist or a machine learning engineer. There are some tips that must be following that can increase the chances of becoming data scientist to a large extent. While learning to code can be an important skill, the ability to communicate well with the members of the team and the other people can make a significant impact for becoming a data scientist respectively. Feel free to take a look at this article where I explain these tips in great detail. 
## 🎼👨‍🎓 Key Learnings
