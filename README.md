...
🏀 [__Assignment 3__](https://github.com/suhasmaddali/Data-Mining-in-Engineering/blob/main/Assignment%203/Homework%203%20Group%2014.pdf) - Most of the assignment was about performing calculations and computing the Sensitivity and Specificity by taking into account various thresholds. Furthermore, there are other interesting questions asked such as lift charts and a few others as well. Overall, the assignment helps in understanding the concepts of sensitivity and specificity well along with a few other things such as true positive rate, false positive rate, precision, recall and f1-score with various threshold values. In addition to this, it is also important to explain to the business people in terms of monetary values instead of with machine learning terms. Therefore, an exercise is given that explains about using total profit as a metric and how it changes based o the various values of threshold that we have taken into consideration. 
