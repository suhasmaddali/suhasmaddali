...
__BERT & ROBERTA__ - BERT stands for Bidirectional Encoder Representations from Transformers while RoBERTa stands for Robustly Optimized BERT Pre-training Approach. These models have been gaining popularity due to their extremely good performance in natual language processing tasks. They are basically transformers with bidirectional context vector representation. In other words, they take into account the context in terms of both the forward pass and the backward pass as well. 
